...
<x-app-layout>
    ...
    <div class="max-w-6xl px-4 py-12 mx-auto text-white">
        ...
        <div class="grid gap-5 mt-12 md:grid-cols-4">
            ...
            <a href="{{ route('product.sales') }}" class="rounded-2xl border-2 border-indigo-500 bg-black/40 p-6 hover:border-fuchsia-400"><p class="text-indigo-300">Earn</p><h2 class="mt-2 text-xl font-semibold">Sales history</h2><p class="mt-2 text-sm text-gray-400">Track public sales and creator commission.</p></a>
