...
<x-app-layout>
    ...
    <div class="mx-auto mt-8 max-w-7xl">
        ...
        <div class="flex items-center gap-2 ml-2 text-white">
            ...
            <a href="{{ route('discover') }}" class="p-1 px-2 transition rounded-md hover:bg-indigo-500/50">Shop
                All</a>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5" />
            ...
            <a href="{{ route('discover', ['type' => 'shirt']) }}" class="p-1 px-2 transition rounded-md hover:bg-indigo-500/50">Standard
                Tee</a>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5" />
            </svg>
            <p class="text-indigo-400">{{ $productType ?? 'Sweatshirt' }}</p>
        </div>
    </div>
    <div
