        ...
        <div class="flex flex-col items-stretch justify-between h-full">
            <div class="flex flex-col flex-shrink-0 w-full">
                ...
                <nav>
                    <div class="flex-grow overflow-x-hidden cursor-pointer md:block md:overflow-y-auto"
                        ...
                        <x-jet-admin-nav href="{{ route('admin.templates') }}" :active="request()->routeIs('admin.templates')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <x-jet-admin-nav href="{{ route('admin.storage') }}" :active="request()->routeIs('admin.storage')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 01-3-3m3 3a3 3 0 100 6h13.5a3 3 0 100-6m-16.5-3a3 3 0 013-3h13.5a3 3 0 013 3m-19.5 0a4.5 4.5 0 01.9-2.7L5.737 5.1a3.375 3.375 0 012.7-1.35h7.126c1.062 0 2.062.5 2.7 1.35l2.587 3.45a4.5 4.5 0 01.9 2.7m0 0a3 3 0 01-3 3m0 3h.008v.008h-.008v-.008zm0-6h.008v.008h-.008v-.008zm-3 6h.008v.008h-.008v-.008zm0-6h.008v.008h-.008v-.008z" />
                              </svg>
                            <span class="mx-4">Storage</span>
                        </x-jet-admin-nav>
                        <x-jet-admin-nav href="{{ route('admin.session') }}" :active="request()->routeIs('admin.session')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9.348 14.651a3.75 3.75 0 010-5.303m5.304 0a3.75 3.75 0 010 5.303m-7.425 2.122a6.75 6.75 0 010-9.546m9.546 0a6.75 6.75 0 010 9.546M5.106 18.894c-3.808-3.808-3.808-9.98 0-13.789m13.788 0c3.808 3.808 3.808 9.981 0 13.79M12 12h.008v.007H12V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                              </svg>
                            <span class="mx-4">Session</span>
                        </x-jet-admin-nav>
            ...
            <div>
                <form method="POST" action="{{ route('logout') }}" x-data>
                    @csrf
                    <a class="flex items-center justify-start px-4 py-3 m-2 text-gray-200 transition bg-transparent rounded-xl hover:bg-gradient-to-r from-rose-700 to-pink-600 focus:ring focus:ring-indigo-500"
